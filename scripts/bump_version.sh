...
sed -i.bak "s/\"version\": \"$OLD_VERSION\"/\"version\": \"$NEW_VERSION\"/g" crates/specado-node/package.json

# Update Python pyproject.toml
sed -i.bak "s/version = \"$OLD_VERSION\"/version = \"$NEW_VERSION\"/g" pyproject.toml
